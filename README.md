...
welcome to our first python project.
this project is used for an implementation of a directed (positive) Weighted Graph in python language.
in this wiki we will expend about the compareation of the run-time complexity of this project, with a similar project written in Java (ex2) and with [networkX](https://networkx.org/) library.

## *info about the compareation:*
there are 6 graphs used for this compareation, the comparation using in 3 diffrent methods:
* the `connected_component(id)` method returns a list of the Strongly Connected Component(SCC) that the given node is a part of. this method using `dfs` algorithm 2 times.
...
* the `shortestPath(src, dest)` method, this method using in Dijkstra's algorithm.

# *outputs:*

in this paragraph we wiil show the outputs of the methods, see that there is no diffrencess in the results betwenn java, python and networkX. 

![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/10_nodes_with_80_edges_given_pos.PNG) ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/10_nodes_with_80_edges_random_pos.PNG)

## *graph with 10 nodes and 80 edges:*
>
>
> ![s](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_10v80e%20python%20nx.jpg)
>
> ![d](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_10v800e%20java.jpg)
>
>

## *graph with 100 nodes and 800 edges:*
>
> ![d](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_100v800e%20python%20nx.jpg)
>
> ![s](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_100v800e%20java.jpg)
>
>

## *graph with 1000 nodes and 8000 edges:*
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_1000v8000e%20python%20nx.jpg)
>
> ![d](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_1000v8000e%20java.jpg)
>

## *graph with 10000 nodes and 80000 edges:*
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_10000v80000e%20python%20nx.jpg)
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_10000v80000e%20java.jpg)
>
>

## *graph with 20,000 nodes and 160,000 edges:*
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_20000v160000e%20python%20nx.jpg)
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_20000v160000e%20java.jpg)
>
>

## *graph with 30,000 nodes and 240,000 edges:*
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_30000v240000e%20python%20nx.jpg)
>
> ![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/outputs/output_30000v240000ejava.jpg)
>
>

# *run time:*

![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/shortest_path.jpg)

![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/connected%20component.jpg)

![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/connected%20components.jpg)

![](https://github.com/mosheCrespin/oop_ex3/blob/master/src/tests/Compare_img/avg%20run%20time.png)
